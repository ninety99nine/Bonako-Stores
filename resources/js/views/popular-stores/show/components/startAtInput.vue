    ...
    <FormItem prop="start_at" :error="serverStartAtError" class="mb-3">
        ...
        <div class="d-flex">
            ...
            <DatePicker :value="initialDate"
                        :disabled="isLoading || (isEditing && !popularStoreForm.reset_dates)"
    ...
    export default {
        ...
        methods: {
            onChange(datetime){
                ...
                this.popularStoreForm.start_at = moment(datetime, 'DD MMM YYYY HH:mm').format('YYYY-MM-DD HH:mm:ss');
        ...
        created(){
            ...
            //  If we have a date
            if( this.popularStoreForm.start_at ){

                //  Convert "31/03/2021 06:30" to "31 Mar 2021 06:30"
                this.initialDate = moment(this.popularStoreForm.start_at, 'YYYY-MM-DD HH:mm:ss').format('DD MMM YYYY HH:mm');
