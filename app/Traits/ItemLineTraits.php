...
use App\Http\Resources\ItemLine as ItemLineResource;
use App\Http\Resources\ItemLines as ItemLinesResource;

trait ItemLineTraits
{
    ...
    public function convertToApiFormat($collection = null)
    {
        try {
            ...
            if( $collection instanceof \Illuminate\Support\Collection ||
                ...
                return new ItemLinesResource($collection);

            // If this instance is not a collection
            }elseif($this instanceof \App\ItemLine){

                //  Transform the single instance
                return new ItemLineResource($this);
    ...
    /**
     *  This method creates a new item line
     */
    public function createResource($data = [])
    {
        try {
             ...
             */
            $this->item_line = $this->create($template);
