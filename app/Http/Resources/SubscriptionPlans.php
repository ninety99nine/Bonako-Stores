...
class SubscriptionPlans extends ResourceCollection
{
    /**
     ...
     * @var string
     */
    public $collects = 'App\Http\Resources\SubscriptionPlan';
    ...
    public function toArray($request)
    {
        ...
        if($this instanceof LengthAwarePaginator ) {
            ...
            $data['_links'] = [
                ...
                'self' => [
                    'href' => url()->full(),
                    'title' => 'These subscription plans',
                ],
        ...
        $data['_embedded'] = [
            'subscription_plans' => $this->collection,
        ];
