...
class PaymentMethods extends ResourceCollection
{
    /**
     ...
     * @var string
     */
    public $collects = 'App\Http\Resources\PaymentMethod';
    ...
    public function toArray($request)
    {
        ...
        $data['_embedded'] = [
            'payment_methods' => $this->collection,
        ];
