...
class MobileVerifications extends ResourceCollection
{
    /**
     ...
     * @var string
     */
    public $collects = 'App\Http\Resources\MobileVerification';
    ...
    public function toArray($request)
    {
        ...
        if( $this->resource instanceof LengthAwarePaginator ) {
            ...
            $data['_links'] = [
                ...
                'self' => [
                    'href' => url()->full(),
                    'title' => 'These mobile verifications',
                ],
        ...
        $data['_embedded'] = [
            'mobile_verification' => $this->collection,
        ];
